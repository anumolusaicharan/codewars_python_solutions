...
#You don't want to convert everything by hand, so you've decided to write a function, celsius_to_romer() that
#takes a temperature in degrees Celsius and returns the equivalent temperature in degrees Rømer.

#For example: celsius_to_romer(24) should return 20.1.
# Given Link for For Converting Celcius to Romer Scale Temp --> https://en.wikipedia.org/wiki/R%C3%B8mer_scale
